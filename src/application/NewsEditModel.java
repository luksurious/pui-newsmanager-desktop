...
class NewsEditModel extends NewsCommonModel {
	...
	private User user;
	/**
	 * Flag used to indicate that exist a modified article. - False: unmodified -
	 * True: modified
	 */
	...
	/**
	 * @return a Property of edited article isDeleted. The returned value is
	 *         suitable for binding
	 */
	...
	/**
	 * Make changes permanent. Changes can't be undone Copy article data from the
	 * edited one to the original
	 */
	public void commit() {
		if (!this.bModified)
