...
/**
 * This is a simple service registry implementation.
 * It can be used to store central services or dependencies to be shared across classes, so they do not need to be passed actively.
 * Instead these can be retrieved from the service registry if they were set before.
 * 
 * @author students
 */
