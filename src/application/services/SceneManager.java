...
/**
 * The SceneManager class takes care of showing scenes. It is an abstraction so
 * that the controllers don't need to worry about loading FXML or remembering
...
public class SceneManager {
	...
	/**
	 * The primary stage for this application. Inside this stage all main views will
	 * be shown.
	 */
	private Stage primaryStage;
	/**
	 * References to the previously loaded scenes, so we can save their state and
	 * show the content as it was before when going back.
	 */
	private HashMap<AppScenes, Scene> loadedScenes = new HashMap<>();
	/**
	 * References to the controllers for all scenes. Controllers must implement the
	 * {@link NewsController} interface.
	 */
	...
	/**
	 * @param primaryStage The main stage of this application. Should only be called
	...
	/**
	 * @return Get the main stage of this application so it can be used in other
	 *         components
	 */
	...
	/**
	 * @param mainStylessheet Set the main stylesheet for the application. Should be
	 *                        set when initializing the application.
	 */
	...
	/**
	 * Show a scene in the main window. If you provide false to overwrite it will
	 * take the state of this scene as it was before.
	 * 
	 * @param sceneConfig The scene to show
	 * @param overwrite   Whether or not to overwrite the previous state of the
	 *                    scene
	 * @throws IOException
	 */
	...
	/**
	 * Show a scene as a modal window on top of the main window. Uses blocking mode,
	 * i.e. will not return until it is closed.
	 * 
	 ...
	 * 
	 * @param sceneConfig The scene to show in a modal
	 * @param blocking    Whether to wait for the modal to close before returning to
	 *                    the caller
	 * @throws IOException
	 */
	 ...
	 * @param overwrite   Whether to overwrite if the scene was loaded previously.
	 *                    If false, it will reuse an already loaded scene.
	...
	/**
	 * Retrieves the controller of a given scene. Only possible if this scene was
	 * loaded before.
	 * 
