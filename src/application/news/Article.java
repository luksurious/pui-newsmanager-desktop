...
/**
 * This class represents an article. An article is formed by: - A title - A
 * subtitle - An Image - HTML text for the abstract - HTML text for the body -
 * An article could be mark as deleted (only administrator users can see an
 * modify it) - An article belong to one category
 * 
 * @author agonzalez
 */
public class Article {
	// Binding attributes: getters and setters methods are providing in order to
	// hiding the use of properties
	...
	// if needBeSaved is true the article was modified by a set method or by a
	// property
	...
	public Article(Article org) {
		this(org.getAbstractText(), org.getBodyText(), org.getTitle(), org.publicationDate, org.idUser, null,
				org.category);
	...
	public Article(String abstractText, String bodyText, String title, Date publicationDate, int idUser,
			String urlImage, String category) {
	...
	public Article(String title, int idUser, String category, String abstractText, String urlImage) {
	...
	/**
	 * Provide access to isDeleted property. Useful for binding operations
	 * 
	...
	/**
	 * Provide access to abstractText property. Useful for binding operations
	 * 
	...
	/**
	 * Provide access to bodyText property. Useful for binding operations
	 * 
	...
	/**
	 * Provide access to subtitle property. Useful for binding operations
	 * 
	...
	/**
	 * Provide access to title property. Useful for binding operations
	 * 
	 * @return title property
	 */
