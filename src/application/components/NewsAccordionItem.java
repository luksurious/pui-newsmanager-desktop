...
public class NewsAccordionItem extends TitledPane {
	...
	public void initialize() {
		...
		// the webview does not show a cursor for the whole control as defined in the FXML
		// so we add a dummy container where we change the pointer to have it consistent with the whole HBox container
	 ...
	 * Shows the buttons to edit and delete
	 * 
	...
	/**
	 * Update the view if no user is logged in.
	 * Hides the buttons to edit and delete
	 */
